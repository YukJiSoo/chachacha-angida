    ...
    try {
      ...
      conn.transaction([
        ...
        function firstAction(binds, callback) {
          conn.insert(
            `insert into RESERV_ORDER ( store_code, customer_code, order_time, reserv_time, no_of_people, total_price, point_discount, coupon_discount, order_status, review_status ) values ( :store_code, :customer_code, :order_time, :reserv_time, :no_of_people, :total_price, :point_discount, :coupon_discount, :order_status, :review_status )`
            binds,
